package de.bsi.testbedutils.eac2.cv;
...
import de.bsi.testbedutils.eac2.DHDomainParameter;
import de.bsi.testbedutils.eac2.DHDomainParameter.Type;
import de.bsi.testbedutils.utilities.CommonUtil;

public class UtilPublicKey {
    public static byte[] getRawKey(DHPublicKey pub) throws IOException {
        return CommonUtil.removeLeadingZeros(pub.getY().toByteArray());
    }
    
    public static byte[] getRawKey(ECPublicKey pub) throws IOException {
    	return getRawKey(pub,false);
    }
    
    public static byte[] getRawKey(ECPublicKey pub, boolean prefix) throws IOException {
