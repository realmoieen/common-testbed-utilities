package de.bsi.testbedutils.eac2;
...
import de.bsi.testbedutils.eac2.cv.CardVerifiableCertificate;
import de.bsi.testbedutils.eac2.cv.EIDCertificateException;
import de.bsi.testbedutils.utilities.Base64Util;
...
public class TerminalAuthenticationSignature 
{
	...
	public byte[] sign(byte[] challenge) throws NoSuchAlgorithmException, NoSuchProviderException, Exception 
	{
		...
		Signature signer = Signature.getInstance(getSignatureAlgo(), new BouncyCastleProvider());
