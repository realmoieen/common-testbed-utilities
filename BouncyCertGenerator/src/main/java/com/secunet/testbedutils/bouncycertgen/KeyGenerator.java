...
public class KeyGenerator
{
	...
	public static KeyPair generateRSAPair(int keylength)
	{
		...
		{
			logger.log(Level.SEVERE, "No suitable provider was found:" + System.getProperty("line.separator") + e.getMessage());
		}
		return null;
	}
	...
	private static KeyPair generateKeyPair(KeyPairGenerator generator, int keylength)
	{
