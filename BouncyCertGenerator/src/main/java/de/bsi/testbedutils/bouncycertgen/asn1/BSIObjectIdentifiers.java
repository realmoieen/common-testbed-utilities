/**
 * Copyright 2013, Tobias Senger This file is part of "certain". certain is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version. certain is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details. You should have received a copy of the GNU General Public License along with certain. If not, see <http://www.gnu.org/licenses/>.
 */
...
public class BSIObjectIdentifiers {
    ...
    // ECC
    public static final ASN1ObjectIdentifier ecc = algorithms.branch("1");

    public static final ASN1ObjectIdentifier keyType = ecc.branch("2");
    ...
    public static final ASN1ObjectIdentifier signatures = ecc.branch("4");
    ...
    public static final ASN1ObjectIdentifier key_establishment = ecc.branch("5");
    ...
    public static final ASN1ObjectIdentifier TA = smartcard.branch("2");

    public static final ASN1ObjectIdentifier TA_RSA = TA.branch("1");
    public static final ASN1ObjectIdentifier TA_RSA_v1_5_SHA_1 = TA_RSA.branch("1");
    public static final ASN1ObjectIdentifier TA_RSA_v1_5_SHA_256 = TA_RSA.branch("2");
    public static final ASN1ObjectIdentifier TA_RSA_PSS_SHA_1 = TA_RSA.branch("3");
    public static final ASN1ObjectIdentifier TA_RSA_PSS_SHA_256 = TA_RSA.branch("4");
    public static final ASN1ObjectIdentifier TA_RSA_v1_5_SHA_512 = TA_RSA.branch("5");
    public static final ASN1ObjectIdentifier TA_RSA_PSS_SHA_512 = TA_RSA.branch("6");

    public static final ASN1ObjectIdentifier TA_ECDSA = TA.branch("2");
    public static final ASN1ObjectIdentifier TA_ECDSA_SHA_1 = TA_ECDSA.branch("1");
    public static final ASN1ObjectIdentifier TA_ECDSA_SHA_224 = TA_ECDSA.branch("2");
    public static final ASN1ObjectIdentifier TA_ECDSA_SHA_256 = TA_ECDSA.branch("3");
    public static final ASN1ObjectIdentifier TA_ECDSA_SHA_384 = TA_ECDSA.branch("4");
    public static final ASN1ObjectIdentifier TA_ECDSA_SHA_512 = TA_ECDSA.branch("5");

    // Chip Authentication
    public static final ASN1ObjectIdentifier CA = smartcard.branch("3");

    public static final ASN1ObjectIdentifier CA_DH = CA.branch("1");
    public static final ASN1ObjectIdentifier CA_DH_3DES_CBC_CBC = CA_DH.branch("1");
    public static final ASN1ObjectIdentifier CA_DH_AES_CBC_CMAC_128 = CA_DH.branch("2");
    public static final ASN1ObjectIdentifier CA_DH_AES_CBC_CMAC_192 = CA_DH.branch("3");
    public static final ASN1ObjectIdentifier CA_DH_AES_CBC_CMAC_256 = CA_DH.branch("4");

    public static final ASN1ObjectIdentifier CA_ECDH = CA.branch("2");
    public static final ASN1ObjectIdentifier CA_ECDH_3DES_CBC_CBC = CA_ECDH.branch("1");
    public static final ASN1ObjectIdentifier CA_ECDH_AES_CBC_CMAC_128 = CA_ECDH.branch("2");
    public static final ASN1ObjectIdentifier CA_ECDH_AES_CBC_CMAC_192 = CA_ECDH.branch("3");
    public static final ASN1ObjectIdentifier CA_ECDH_AES_CBC_CMAC_256 = CA_ECDH.branch("4");

    // PACE
    public static final ASN1ObjectIdentifier PACE = smartcard.branch("4");

    public static final ASN1ObjectIdentifier PACE_DH_GM = PACE.branch("1");
    public static final ASN1ObjectIdentifier PACE_DH_GM_3DES_CBC_CBC = PACE_DH_GM.branch("1");
    public static final ASN1ObjectIdentifier PACE_DH_GM_AES_CBC_CMAC_128 = PACE_DH_GM.branch("2");
    public static final ASN1ObjectIdentifier PACE_DH_GM_AES_CBC_CMAC_192 = PACE_DH_GM.branch("3");
    public static final ASN1ObjectIdentifier PACE_DH_GM_AES_CBC_CMAC_256 = PACE_DH_GM.branch("4");

    public static final ASN1ObjectIdentifier PACE_ECDH_GM = PACE.branch("2");
    public static final ASN1ObjectIdentifier PACE_ECDH_GM_3DES_CBC_CBC = PACE_ECDH_GM.branch("1");
    public static final ASN1ObjectIdentifier PACE_ECDH_GM_AES_CBC_CMAC_128 = PACE_ECDH_GM.branch("2");
    public static final ASN1ObjectIdentifier PACE_ECDH_GM_AES_CBC_CMAC_192 = PACE_ECDH_GM.branch("3");
    public static final ASN1ObjectIdentifier PACE_ECDH_GM_AES_CBC_CMAC_256 = PACE_ECDH_GM.branch("4");

    public static final ASN1ObjectIdentifier PACE_DH_IM = PACE.branch("3");
    public static final ASN1ObjectIdentifier PACE_DH_IM_3DES_CBC_CBC = PACE_DH_IM.branch("1");
    public static final ASN1ObjectIdentifier PACE_DH_IM_AES_CBC_CMAC_128 = PACE_DH_IM.branch("2");
    public static final ASN1ObjectIdentifier PACE_DH_IM_AES_CBC_CMAC_192 = PACE_DH_IM.branch("3");
    public static final ASN1ObjectIdentifier PACE_DH_IM_AES_CBC_CMAC_256 = PACE_DH_IM.branch("4");

    public static final ASN1ObjectIdentifier PACE_ECDH_IM = PACE.branch("4");
    public static final ASN1ObjectIdentifier PACE_ECDH_IM_3DES_CBC_CBC = PACE_ECDH_IM.branch("1");
    public static final ASN1ObjectIdentifier PACE_ECDH_IM_AES_CBC_CMAC_128 = PACE_ECDH_IM.branch("2");
    public static final ASN1ObjectIdentifier PACE_ECDH_IM_AES_CBC_CMAC_192 = PACE_ECDH_IM.branch("3");
    public static final ASN1ObjectIdentifier PACE_ECDH_IM_AES_CBC_CMAC_256 = PACE_ECDH_IM.branch("4");

    public static final ASN1ObjectIdentifier PACE_ECDH_CAM = PACE.branch("6");
    public static final ASN1ObjectIdentifier PACE_ECDH_CAM_AES_CBC_CMAC_128 = PACE_ECDH_IM.branch("2");
    public static final ASN1ObjectIdentifier PACE_ECDH_CAM_AES_CBC_CMAC_192 = PACE_ECDH_IM.branch("3");
    public static final ASN1ObjectIdentifier PACE_ECDH_CAM_AES_CBC_CMAC_256 = PACE_ECDH_IM.branch("4");

    // Restricted Identification
    public static final ASN1ObjectIdentifier RI = smartcard.branch("5");

    public static final ASN1ObjectIdentifier RI_DH = RI.branch("1");
    public static final ASN1ObjectIdentifier RI_DH_SHA_1 = RI_DH.branch("1");
    public static final ASN1ObjectIdentifier RI_DH_SHA_224 = RI_DH.branch("2");
    public static final ASN1ObjectIdentifier RI_DH_SHA_256 = RI_DH.branch("3");
    public static final ASN1ObjectIdentifier RI_DH_SHA_384 = RI_DH.branch("4");
    public static final ASN1ObjectIdentifier RI_DH_SHA_512 = RI_DH.branch("5");

    public static final ASN1ObjectIdentifier RI_ECDH = RI.branch("2");
    public static final ASN1ObjectIdentifier RI_ECDH_SHA_1 = RI_ECDH.branch("1");
    public static final ASN1ObjectIdentifier RI_ECDH_SHA_224 = RI_ECDH.branch("2");
    public static final ASN1ObjectIdentifier RI_ECDH_SHA_256 = RI_ECDH.branch("3");
    public static final ASN1ObjectIdentifier RI_ECDH_SHA_384 = RI_ECDH.branch("4");
    public static final ASN1ObjectIdentifier RI_ECDH_SHA_512 = RI_ECDH.branch("5");
    ...
    public static final ASN1ObjectIdentifier IS = roles.branch("1");
    public static final ASN1ObjectIdentifier AT = roles.branch("2");
    public static final ASN1ObjectIdentifier AT_eIDAccess = AT.branch("1");
    public static final ASN1ObjectIdentifier AT_specialFunctions = AT.branch("2");
    public static final ASN1ObjectIdentifier AT_eID_Biometrics = AT.branch("3");
    public static final ASN1ObjectIdentifier ST = roles.branch("3");
