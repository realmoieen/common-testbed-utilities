...
import de.bsi.testbedutils.cvc.cvcertificate.exception.CertificateDescGenException;
import de.bsi.testbedutils.cvc.cvcertificate.exception.CertificateDescParseException;
/**
...
public class CertificateDescription
{
	...
	protected void parseTaggedObj(DERTaggedObject obj) throws CertificateDescParseException
	{
		...
		{
		case 1:
			m_issuerName = getUTF8String(obj.getExplicitBaseObject());
			break;
		case 2:
			m_issuerURL = getPrintableString(obj.getExplicitBaseObject());
			break;
		case 3:
			m_subjectName = getUTF8String(obj.getExplicitBaseObject());
			break;
		case 4:
			m_subjectURL = getPrintableString(obj.getExplicitBaseObject());
			break;
		case 5:
			parseTermsOfUsage(obj.getExplicitBaseObject());
			break;
		case 6:
			m_redirectURL = getPrintableString(obj.getExplicitBaseObject());
			break;
		case 7:
			parseCommCerts(obj.getExplicitBaseObject());
			break;
		default:
			throw new CertificateDescParseException();
		}
