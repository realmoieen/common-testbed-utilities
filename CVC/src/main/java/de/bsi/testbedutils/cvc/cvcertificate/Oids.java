...
public class Oids {
    ...
    /**
     * Terminal authentication signature algorithm RSA v1.5 SHA 512 OID
     */
    public static final byte OID_RSA_v1_5_SHA_512[] = { 0x01, 0x05 };
    /**
    ...
    /**
     * Terminal authentication signature algorithm RSA PSS SHA 512 OID
     */
    public static final byte OID_RSA_PSS_SHA_512[] = { 0x01, 0x06 };
    /**
    ...
    /**
     * Terminal authentication signature algorithm ECC SHA384 OID
     */
    public static final byte OID_ECDSA_SHA_384[] = { 0x02, 0x04 };
    /**
     * Terminal authentication signature algorithm ECC SHA512 OID
     */
    public static final byte OID_ECDSA_SHA_512[] = { 0x02, 0x05 };
