...
public class CVPubKeyHolder {
    ...
    CVMissingKeyException, CVKeyTypeNotSupportedException {
    	return generateCertPubKey(Oids.OID_TA);
    }
     ...
     * @throws CVKeyTypeNotSupportedException
     */
    public DataBuffer generateCertPubKey(byte[] oidPart) throws CVSignOpKeyMismatchException, CVInvalidKeySourceException,
            CVMissingKeyException, CVKeyTypeNotSupportedException {
