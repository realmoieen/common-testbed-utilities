...
import de.bsi.testbedutils.cvc.cvcertificate.exception.CVCertificateHolderReferenceInvalidCountryCode;
import de.bsi.testbedutils.cvc.cvcertificate.exception.CVCertificateHolderReferenceTooLong;
...
public class CVCertificateHolderReference {
	...
	public static void verify(String strCertHolderRef) throws CVCertificateHolderReferenceTooLong, CVAuthorityRefNotValidException
	{
		...
		// Long sequence
		if(!strCertHolderRef.matches("[A-Z]{2}.{0,14}[0-9A-Z]{5}")/* &&
				// short sequence
