package de.bsi.testbedutils.utilities;
...
public class BouncyCastleTlsHelperTest {
    ...
    public void testConvertCipherSuiteIntToString() {
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x003C), "TLS_RSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x003D), "TLS_RSA_WITH_AES_256_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x009C), "TLS_RSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x009D), "TLS_RSA_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC004), "TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC005), "TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC009), "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC00A), "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC00E), "TLS_ECDH_RSA_WITH_AES_128_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC00F), "TLS_ECDH_RSA_WITH_AES_256_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC013), "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC014), "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x003E), "TLS_DH_DSS_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x003F), "TLS_DH_RSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x0040), "TLS_DHE_DSS_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x0067), "TLS_DHE_RSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x0068), "TLS_DH_DSS_WITH_AES_256_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x0069), "TLS_DH_RSA_WITH_AES_256_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x006A), "TLS_DHE_DSS_WITH_AES_256_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x006B), "TLS_DHE_RSA_WITH_AES_256_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x009E), "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x009F), "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x00A0), "TLS_DH_RSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x00A1), "TLS_DH_RSA_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x00A2), "TLS_DHE_DSS_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x00A3), "TLS_DHE_DSS_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x00A4), "TLS_DH_DSS_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0x00A5), "TLS_DH_DSS_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC023), "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC024), "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC025), "TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC026), "TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC027), "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC028), "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC029), "TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC02A), "TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC02B), "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC02C), "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC02D), "TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC02E), "TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC02F), "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC030), "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC031), "TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256");
        assertEquals(BouncyCastleTlsHelper.convertCipherSuiteIntToString(0xC032), "TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384");
    }
    ...
    public void testConvertNamedCurveIntToString() {
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(1), "sect163k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(2), "sect163r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(3), "sect163r2");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(4), "sect193r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(5), "sect193r2");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(6), "sect233k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(7), "sect233r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(8), "sect239k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(9), "sect283k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(10), "sect283r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(11), "sect409k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(12), "sect409r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(13), "sect571k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(14), "sect571r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(15), "secp160k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(16), "secp160r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(17), "secp160r2");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(18), "secp192k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(19), "secp192r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(20), "secp224k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(21), "secp224r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(22), "secp256k1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(23), "secp256r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(24), "secp384r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(25), "secp521r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(26), "brainpoolP256r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(27), "brainpoolP384r1");
        assertEquals(BouncyCastleTlsHelper.convertNamedCurveIntToString(28), "brainpoolP512r1");
    }
    ...
    public void testConvertDHParametersObjectToDHStandardGroupsString() {
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc2409_768), "rfc2409_768");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc2409_1024), "rfc2409_1024");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc3526_1536), "rfc3526_1536");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc3526_2048), "rfc3526_2048");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc3526_3072), "rfc3526_3072");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc3526_4096), "rfc3526_4096");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc3526_6144), "rfc3526_6144");
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc3526_8192), "rfc3526_8192");
        // rfc4306_768 is equal to rfc2409_768
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc4306_768), "rfc2409_768");
        // rfc4306_1024 is equal to rfc2409_1024
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc4306_1024), "rfc2409_1024");
//        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc5114_1024_160), "rfc5114_1024_160");
//        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc5114_2048_224), "rfc5114_2048_224");
//        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc5114_2048_256), "rfc5114_2048_256");
        // rfc4306_768 is equal to rfc2409_768
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc5996_768), "rfc2409_768");
        // rfc4306_1024 is equal to rfc2409_1024
        assertEquals(BouncyCastleTlsHelper.convertDHParametersObjectToDHStandardGroupsString(DHStandardGroups.rfc5996_1024), "rfc2409_1024");
    }
    
    @Test
    public void testConvertDHStandardGroupsStringToDHParametersObject() {
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc2409_768"), DHStandardGroups.rfc2409_768);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc2409_1024"), DHStandardGroups.rfc2409_1024);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc3526_1536"), DHStandardGroups.rfc3526_1536);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc3526_2048"), DHStandardGroups.rfc3526_2048);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc3526_3072"), DHStandardGroups.rfc3526_3072);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc3526_4096"), DHStandardGroups.rfc3526_4096);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc3526_6144"), DHStandardGroups.rfc3526_6144);
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc3526_8192"), DHStandardGroups.rfc3526_8192);
        // rfc4306_768 is equal to rfc2409_768
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc4306_768"), DHStandardGroups.rfc2409_768);
        // rfc4306_1024 is equal to rfc2409_1024
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc4306_1024"), DHStandardGroups.rfc2409_1024);
//        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc5114_1024_160"), DHStandardGroups.rfc5114_1024_160);
//        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc5114_2048_224"), DHStandardGroups.rfc5114_2048_224);
//        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc5114_2048_256"), DHStandardGroups.rfc5114_2048_256);
        // rfc4306_768 is equal to rfc2409_768
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc5996_768"), DHStandardGroups.rfc2409_768);
        // rfc4306_1024 is equal to rfc2409_1024
        assertEquals(BouncyCastleTlsHelper.convertDHStandardGroupsStringToDHParametersObject("rfc5996_1024"), DHStandardGroups.rfc2409_1024);
    }
